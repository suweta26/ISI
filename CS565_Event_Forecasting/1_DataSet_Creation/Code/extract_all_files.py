...
db = MySQLdb.connect("127.0.0.1","root","password","TESTDB")
# prepare a cursor object using cursor() method
cursor = db.cursor()
published_on=0
count=0
# Prepare SQL query to INSERT a record into the database.
sql = """SELECT * FROM News where (Source = 'hindustantimes' OR Source = 'indianexpress' OR Source = 'toi') """
try:
